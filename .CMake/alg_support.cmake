...
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin" AND OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_BMI1_INSTRUCTIONS AND OQS_USE_PCLMUL_INSTRUCTIONS)
...
cmake_dependent_option(OQS_ENABLE_KEM_hqc_rmrs_128 "" ON "OQS_ENABLE_KEM_HQC" OFF)
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin" AND OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_BMI1_INSTRUCTIONS AND OQS_USE_PCLMUL_INSTRUCTIONS)
    cmake_dependent_option(OQS_ENABLE_KEM_hqc_rmrs_128_avx2 "" ON "OQS_ENABLE_KEM_hqc_rmrs_128" OFF)
endif()
cmake_dependent_option(OQS_ENABLE_KEM_hqc_rmrs_192 "" ON "OQS_ENABLE_KEM_HQC" OFF)
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin" AND OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_BMI1_INSTRUCTIONS AND OQS_USE_PCLMUL_INSTRUCTIONS)
    cmake_dependent_option(OQS_ENABLE_KEM_hqc_rmrs_192_avx2 "" ON "OQS_ENABLE_KEM_hqc_rmrs_192" OFF)
endif()
cmake_dependent_option(OQS_ENABLE_KEM_hqc_rmrs_256 "" ON "OQS_ENABLE_KEM_HQC" OFF)
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin" AND OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_BMI1_INSTRUCTIONS AND OQS_USE_PCLMUL_INSTRUCTIONS)
    cmake_dependent_option(OQS_ENABLE_KEM_hqc_rmrs_256_avx2 "" ON "OQS_ENABLE_KEM_hqc_rmrs_256" OFF)
endif()
