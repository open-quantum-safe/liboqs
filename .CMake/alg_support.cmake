...
if (OQS_ENABLE_KEM_ml_kem_512 OR OQS_ENABLE_KEM_ml_kem_512_ipd)
    set(OQS_ENABLE_KEM_ml_kem_512 "alias" ON)
    set(OQS_ENABLE_KEM_ml_kem_512_ipd "alias" ON)
endif()
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_BMI2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
...
if (OQS_ENABLE_KEM_ml_kem_768 OR OQS_ENABLE_KEM_ml_kem_768_ipd)
    set(OQS_ENABLE_KEM_ml_kem_768 "alias" ON)
    set(OQS_ENABLE_KEM_ml_kem_768_ipd "alias" ON)
endif()
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_BMI2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
...
if (OQS_ENABLE_KEM_ml_kem_1024 OR OQS_ENABLE_KEM_ml_kem_1024_ipd)
    set(OQS_ENABLE_KEM_ml_kem_1024 "alias" ON)
    set(OQS_ENABLE_KEM_ml_kem_1024_ipd "alias" ON)
endif()
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_BMI2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
...
if (OQS_ENABLE_SIG_ml_dsa_44 OR OQS_ENABLE_SIG_ml_dsa_44_ipd)
    set(OQS_ENABLE_SIG_ml_dsa_44 "alias" ON)
    set(OQS_ENABLE_SIG_ml_dsa_44_ipd "alias" ON)
endif()
if(CMAKE_SYSTEM_NAME MATCHES "Darwin|Linux")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
...
if (OQS_ENABLE_SIG_ml_dsa_65 OR OQS_ENABLE_SIG_ml_dsa_65_ipd)
    set(OQS_ENABLE_SIG_ml_dsa_65 "alias" ON)
    set(OQS_ENABLE_SIG_ml_dsa_65_ipd "alias" ON)
endif()
if(CMAKE_SYSTEM_NAME MATCHES "Darwin|Linux")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
...
if (OQS_ENABLE_SIG_ml_dsa_87 OR OQS_ENABLE_SIG_ml_dsa_87_ipd)
    set(OQS_ENABLE_SIG_ml_dsa_87 "alias" ON)
    set(OQS_ENABLE_SIG_ml_dsa_87_ipd "alias" ON)
endif()
if(CMAKE_SYSTEM_NAME MATCHES "Darwin|Linux")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
