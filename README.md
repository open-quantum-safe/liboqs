...
| MQOM               | Under [NIST](https://csrc.nist.gov/csrc/media/Projects/pqc-dig-sig/documents/round-2/spec-files/mqom-spec-round2-web.pdf) consideration                              | [`mqom/mqom-v2@15667db`](https://github.com/mqom/mqom-v2/commit/15667dbc45448cce9265470921a2e51d4a134b2b)                                   |
