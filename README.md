...
| Algorithm family   | Standardization status                                                                                                                                                                                                                    | Primary implementation                                                                                                                    | [Upstream maintenance](ALGORITHMS.md#upstream-maintenance)                                                          | [OQS tier](ALGORITHMS.md#oqs-support-tier)   |
|:-------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------|:---------------------------------------------|
...
| ML-DSA             | Standardized by [NIST](https://csrc.nist.gov/pubs/fips/204/final)                                                                                                    | [`pq-code-package/mldsa-native@f48f164`](https://github.com/pq-code-package/mldsa-native/commit/f48f164cefb07f4ffa519ddda7cee670b8ee3517)   | [Actively maintained](https://github.com/pq-code-package/mldsa-native) | Tier 2 (Supported)                           |
