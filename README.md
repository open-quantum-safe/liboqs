...
| Algorithm family   | Standardization status                                                                                                                                               | Primary implementation                                                                                                                      |
|:-------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------|
| CROSS              | Under [NIST](https://www.cross-crypto.com/CROSS_Specification_v2.2.pdf) consideration                                                                                | [`CROSS-signature/CROSS-lib-oqs@018fb70`](https://github.com/CROSS-signature/CROSS-lib-oqs/commit/018fb70bc40a98c7840401ef5fb6ee2267a49ad5) |
