...
class HttpRequestHandler:
    def __init__(
        ...
        *,
        ...
        print("In example server :class HttpRequestHandler init")
    ...
    def http_event_received(self, event: H3Event) -> None:
        print("In example server :class HttpRequestHandler HTTP event recieved")
    ...
    async def receive(self) -> Dict:
        print("In example server :class HttpRequestHandler recieve")
        return await self.queue.get()

    async def send(self, message: Dict) -> None:
        print("In example server :class HttpRequestHandler send")
        if message["type"] == "http.response.start":
            ...
            # send push promise
            print("In example server :class HttpRequestHandler send push promise")
            try:
...
class WebSocketHandler:
    def __init__(
        ...
        *,
        ...
        print("In example server :class WebSocketHandler init")
        self.closed = False
        self.connection = connection
    ...
    def http_event_received(self, event: H3Event) -> None:
        print("In example server :class WebSocketHandler HTTP event recieved")
    ...
    def websocket_event_received(self, event: wsproto.events.Event) -> None:
        print("In example server :class WebSocketHandler HTTP Websocket event received")
    ...
    async def run_asgi(self, app: AsgiApplication) -> None:
        print("In example server :class WebSocketHandler run assign")
    ...
    async def receive(self) -> Dict:
        print("In example server :class WebSocketHandler recieve")
        return await self.queue.get()

    async def send(self, message: Dict) -> None:
        print("In example server :class WebSocketHandler send")
        data = b""
        end_stream = False
...
class HttpServerProtocol(QuicConnectionProtocol):
    def __init__(self, *args, **kwargs) -> None:
        print("In example server :class httpserverprotocol init")
        super().__init__(*args, **kwargs)
        self._handlers: Dict[int, Handler] = {}
        self._http: Optional[HttpConnection] = None

    def http_event_received(self, event: H3Event) -> None:
        print("In example server :class httpserverprotocol http event received")
    ...
    def quic_event_received(self, event: QuicEvent) -> None:
        print("In example server :class httpserverprotocol QUIC event received")
...
class SessionTicketStore:
    ...
    def __init__(self) -> None:
        print("In example server: class SessionTicket init")
        self.tickets: Dict[bytes, SessionTicket] = {}

    def add(self, ticket: SessionTicket) -> None:
        print("In example server: class SessionTicket add")
        self.tickets[ticket.ticket] = ticket

    def pop(self, label: bytes) -> Optional[SessionTicket]:
        print("In example server: class SessionTicket pop")
...
class QuicLoggerCustom(QuicLogger):
    ...
    def __init__(self, path: str) -> None:
        print("In example server: class QuicLoggerCustom init")
...
if __name__ == "__main__":
    print ("In example server: class main ")
    ...
    # create QUIC logger
    print("In example server: class main create QUIC logger")
    if args.quic_log:
    ...
    print("In example server: class main load ssl cert and key")
