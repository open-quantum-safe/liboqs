...
class URL:
    def __init__(self, url: str) -> None:
        print("In example client class url init")
        parsed = urlparse(url)
...
class HttpRequest:
    def __init__(
        ...
        print("In example client class HttpRequest: http request init")
...
class WebSocket:
    def __init__(
        ...
        print("In example class WebSocket: client websocket init")
        self.http = http
    ...
    async def close(self, code=1000, reason="") -> None:
        ...
        """
        print("In example client class WebSocket: closing handshake")
    ...
    async def recv(self) -> str:
        ...
        """
        print("In example client class WebSocket: recieve message")
    ...
    async def send(self, message: str) -> None:
        ...
        Send a message.
        """
        print("In example client class WebSocket: send a message")
    ...
    def http_event_received(self, event: H3Event) -> None:
        print ("In example client class WebSocket: http event recieved")
        print ("Test")
    ...
    def websocket_event_received(self, event: wsproto.events.Event) -> None:
        print("In example client websocket event recieved")
...
class HttpClient(QuicConnectionProtocol):
    def __init__(self, *args, **kwargs) -> None:
        print("In example client class HttpClient: http client init")
    ...
    async def get(self, url: str, headers: Dict = {}) -> Deque[H3Event]:
        ...
        """
        print("In example client class HttpClient: get request")
    ...
    async def post(self, url: str, data: bytes, headers: Dict = {}) -> Deque[H3Event]:
        ...
        """
        print("In example client class HttpClient: post request")
        return await self._request(
    ...
    async def websocket(self, url: str, subprotocols: List[str] = []) -> WebSocket:
        ...
        Open a WebSocket.
        """
        print("In example client class HttpClient: open websocket")
    ...
    def http_event_received(self, event: H3Event) -> None:
        print("In example client class HttpClient: http event recieved")
        if isinstance(event, (HeadersReceived, DataReceived)):
            stream_id = event.stream_id
            if stream_id in self._request_events:
                # http
                print("In example client class HttpClient: http event recieved http")
                ...
                # websocket
                print("In example client class HttpClient: http event recieved websocket")               
                websocket = self._websockets[stream_id]
                websocket.http_event_received(event)

            elif event.push_id in self.pushes:
                # push
                print("In example client class HttpClient: http event recieved push")
    ...
    def quic_event_received(self, event: QuicEvent) -> None:
        ...
        print("In example client class HttpClient: quic event recieved")
        if self._http is not None:
            for http_event in self._http.handle_event(event):
                self.http_event_received(http_event)

    async def _request(self, request: HttpRequest):
        print("In example client class HttpClient: quic event recieved request")
        stream_id = self._quic.get_next_available_stream_id()
...
async def perform_http_request(
    ...
    print("In example client class HttpClient: perform http request")
    # perform request
    start = time.time()
    if data is not None:
    ...
    if output_dir is not None:
        print("In example client class HttpClient: perform http request output response")
...
def save_session_ticket(ticket: SessionTicket) -> None:
    ...
    is received.
    """
    print ("In example client save session ticket")
...
async def run(
    ...
    async with connect(
        ...
        if parsed.scheme == "wss":
            ...
            print ("In example client: run send message")
            ...
            print ("In example client: run request message")
            # perform request
            coros = [
...
if __name__ == "__main__":
    ...
    print ("In example client: main prepare configguration")
    configuration = QuicConfiguration(
    ...
    print ("In example client: main loop until complete")
    try:
