...
class QuicConnection:
    ...
    def __init__(
        ...
        *,
        ...
        print ("In connection: QUICconnection init")    
    ...
    def change_connection_id(self) -> None:
        ...
        """
        print ("In connection: change connection id ")
    ...
    def connect(self, addr: NetworkAddress, now: float) -> None:
        ...
        """
        print ("In connection: initiate TLS handshake: connect")
        assert (
    ...
    def datagrams_to_send(self, now: float) -> List[Tuple[bytes, NetworkAddress]]:
        ...
        :param now: The current time.
        """
        print("In connection: datagrams to send")
    ...
    def get_next_available_stream_id(self, is_unidirectional=False) -> int:
        ...
        """
        print ("In connection: get next available stream id")
    ...
    def next_event(self) -> Optional[events.QuicEvent]:
        ...
        """
        print ("In connection: next event")
        try:
    ...
    def receive_datagram(self, data: bytes, addr: NetworkAddress, now: float) -> None:
        ...
        :param now: The current time.
        """
        print ("In connection: receive datagram ")
        ...
        while not buf.eof():
            ...
            if not self._is_client and self._state == QuicConnectionState.FIRSTFLIGHT:
                ...
                print ("In connectrion: server initiation")
    ...
    def request_key_update(self) -> None:
        ...
        """
        print ("In connection: request key update")
    ...
    def send_datagram_frame(self, data: bytes) -> None:
        ...
        """
        print ("In Connection: send datagram frame")
    ...
    def send_stream_data(
        ...
        """
        print ("In connection: send stream data")
    ...
    def _assert_stream_can_receive(self, frame_type: int, stream_id: int) -> None:
        ...
        """
        print ("In Connection: stream can recieve")
    ...
    def _assert_stream_can_send(self, frame_type: int, stream_id: int) -> None:
        ...
        """
        print ("In Connection: stream can send")
    ...
    def _close_begin(self, is_initiator: bool, now: float) -> None:
        ...
        """
        print ("In Connection: begin close procedure")
    ...
    def _close_end(self) -> None:
        ...
        """
        print ("In Connection: end close procedure")
        self._close_at = None
    ...
    def _connect(self, now: float) -> None:
        ...
        """
        print ("In Connection: start client handshake")
    ...
    def _create_stream(self, stream_id: int) -> QuicStream:
        ...
        """
        print ("In Connection: create stream")
        # determine limits
        if stream_is_unidirectional(stream_id):
    ...
    def _find_network_path(self, addr: NetworkAddress) -> QuicNetworkPath:
        print ("In Connection: Find network path")
    ...
    def _get_or_create_stream(self, frame_type: int, stream_id: int) -> QuicStream:
        ...
        """
        print ("In Connection: Get or create stream")
    ...
    def _handle_session_ticket(self, session_ticket: tls.SessionTicket) -> None:
        print ("In Connection: handle session ticket")
        if (
    ...
    def _initialize(self, peer_cid: bytes) -> None:
        print ("In Connection: initiate TLS")
        # TLS
    ...
    def _handle_ack_frame(
        ...
        Handle an ACK frame.
        """
        print ("In Connection: handle ack frame")
    ...
    def _handle_connection_close_frame(
        ...
        """
        print ("In Connection: handle close frame")
    ...
    def _handle_crypto_frame(
        ...
        """
        print ("In Connection: handle crypto frame")
    ...
    def _handle_data_blocked_frame(
        ...
        """
        print ("In Connection: handle data blocked frame")
    ...
    def _handle_datagram_frame(
        ...
        """
        print ("In Connection: Handle data frame")
        start = buf.tell()
    ...
    def _handle_handshake_done_frame(
        ...
        """
        print ("In Connection: handle handshake done frame")
        # log frame
        if self._quic_logger is not None:
            context.quic_logger_frames.append(
    ...
    def _handle_max_data_frame(
        ...
        """
        print ("In Connection: handle max data frame")
    ...
    def _handle_max_stream_data_frame(
        ...
        """
        print ("In Connection: handle max stream data frame")
    ...
    def _handle_max_streams_bidi_frame(
        ...
        """
        print ("In Connection: handle max streams bidirectional frame")
    ...
    def _handle_max_streams_uni_frame(
        ...
        """
        print ("In Connection: hande max streams uni frame")
        max_streams = buf.pull_uint_var()
    ...
    def _handle_new_connection_id_frame(
        ...
        """
        print ("In Connection: Handle new connection id frame")
    ...
    def _handle_new_token_frame(
        ...
        """
        print ("In Connection: Handle new token frame")
        length = buf.pull_uint_var()
    ...
    def _handle_padding_frame(
        ...
        """
        print ("In Connection: handle padding frame")
        # consume padding
        pos = buf.tell()
