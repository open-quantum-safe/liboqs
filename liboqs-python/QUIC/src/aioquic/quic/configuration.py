...
class QuicConfiguration:
    ...
    def load_cert_chain(
        ...
        """
        print ("In QUIC configuration: Opening certificates")
        ...
        if keyfile is not None:
            print ("In QUIC configuration: Opening private key")
    ...
    def load_verify_locations(
        ...
        print ("In QUIC configuration: load verify locations for certificates CA")
        """
