...
def generate_kem_source(
    ...
    # FIX: implement these
    oqs_kem_new = OQS_KEM_NEW_IMPL
    extern_api_decl = OQS_KEM_EXTERN_API_DECLARATIONS
    keypair_derand = OQS_KEM_KEYPAIR_DERAND_IMPL
    keypair = OQS_KEM_KEYPAIR_IMPL
    encaps_derand = OQS_KEM_ENCAPS_DERAND_IMPL
    encaps = OQS_KEM_ENCAPS_IMPL
    decaps = OQS_KEM_DECAPS_IMPL
    source = f"""\
// {SPDX_LICENSE_IDENTIFIER}
// This file is generated by OQS Builder ({__name__}.{currentframe_funcname()})
