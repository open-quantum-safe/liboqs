...
##### OQS_COPY_FROM_PQCLEAN_FRAGMENT_ARG_DISBL_SET_WRAP_START
  ...
  ARG_DISBL_SET_WRAP([kem-ntskem], [kem_ntskem], [ENABLE_KEM_NTSKEM], [src/kem/ntskem])
...
##### OQS_COPY_FROM_PQCLEAN_FRAGMENT_AM_COND_IF_START
  ...
  AM_COND_IF([ENABLE_KEM_NTSKEM], [
    AC_DEFINE(OQS_ENABLE_KEM_ntskem_12_64, 1, "Define to 1 when NTS-KEM(12,64) enabled")
  ])
