...
OQS_SIG_STFL *OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_new(void) {
	...
	sig->length_public_key = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_length_pk;
	sig->length_secret_key = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_length_sk;
	sig->length_signature = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_length_signature;

	sig->keypair = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_keypair;
	sig->sign = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_sign;
	sig->verify = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_verify;
	sig->sigs_remaining = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_sigs_remaining;
	sig->sigs_total = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_sigs_total;

	return sig;
}

OQS_SIG_STFL_SECRET_KEY *OQS_SECRET_KEY_XMSSMT_SHA256_H20_2_new(void) {
	...
	sk->length_secret_key = OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_length_sk;
...
OQS_API OQS_STATUS OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_keypair(XMSS_UNUSED_ATT uint8_t *public_key, XMSS_UNUSED_ATT uint8_t *secret_key) {

	if (public_key == NULL || secret_key == NULL) {
		return OQS_ERROR;
	}

	const uint32_t xmssmt_sha256_h20_2_oid = 0x01;
	if (xmssmt_keypair(public_key, secret_key, xmssmt_sha256_h20_2_oid)) {
		return OQS_ERROR;
	}
...
OQS_API OQS_STATUS OQS_SIG_STFL_alg_xmssmt_sha256_h20_2_sign(uint8_t *signature, size_t *signature_len, XMSS_UNUSED_ATT const uint8_t *message, XMSS_UNUSED_ATT size_t message_len, XMSS_UNUSED_ATT uint8_t *secret_key) {
