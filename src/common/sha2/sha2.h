...
/**
 * \brief Process a message with SHA-224 and return the hash code in the output byte array.
 *
...
/**
 * \brief Allocate and initialize the state for the SHA-224 incremental hashing API.
 *
...
/**
 * \brief Duplicate state for the SHA-224 incremental hashing API.
 *
...
/**
 * \brief Process blocks with SHA-224 and update the state.
 *
...
/**
 * \brief Process more message bytes with SHA-224 and return the hash code in the output byte array.
 *
