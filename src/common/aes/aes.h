...
/**
 * Function to fill a key schedule given an initial key for use with ECB mode.
 *
...
/**
 * Function to fill a key schedule given an initial key for use with CTR mode.
 *
 * @param key            Initial Key.
 * @param schedule       Abstract data structure for a key schedule.
 */
 ...
 *
 * @param schedule       Schedule generated with OQS_AES128_ECB_load_schedule or
 *                       OQS_AES128_CTR_load_schedule.
 */
