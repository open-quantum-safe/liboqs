...
void oqs_aes256_ctr_enc_sch_upd_blks_u64_c(uint64_t iv, void *schedule, uint8_t *out, size_t out_blks);
...
void oqs_aes256_load_iv_no_bitslice(const uint8_t *key, const uint8_t *iv, size_t iv_len, void *_schedule);
