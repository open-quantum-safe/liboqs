...
OQS_SIG *OQS_SIG_falcon_1024_new() {
	...
	sig->alg_version = "https://github.com/PQClean/PQClean/commit/bad9956869d174c4ff581379a5291c58507c7248";
...
int PQCLEAN_FALCON1024_CLEAN_crypto_sign_signature(uint8_t *sig, size_t *siglen, const uint8_t *m, size_t mlen, const uint8_t *sk);
int PQCLEAN_FALCON1024_CLEAN_crypto_sign_verify(const uint8_t *sig, size_t siglen, const uint8_t *m, size_t mlen, const uint8_t *pk);
