...
#else
#define inner_gf65376_umul(lo, hi, a, b)                                                                                \
    do {                                                                                                               \
...
#define inner_gf65376_umul_add(lo, hi, x, y, z)                                                                        \
    do {                                                                                                               \
        ...
        inner_gf65376_umul(umul_lo, umul_hi, (x), (y));                                                                 \
...
#define inner_gf65376_umul_x2(lo, hi, x1, y1, x2, y2)                                                                  \
    do {                                                                                                               \
        uint64_t umul_lo, umul_hi;                                                                                     \
        inner_gf65376_umul(umul_lo, umul_hi, (x1), (y1));                                                              \
        uint64_t umul_lo2, umul_hi2;                                                                                   \
        inner_gf65376_umul(umul_lo2, umul_hi2, (x2), (y2));                                                            \
        unsigned char umul_cc;                                                                                         \
