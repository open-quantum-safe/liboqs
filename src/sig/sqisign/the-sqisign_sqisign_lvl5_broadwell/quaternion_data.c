...
#if 0
#elif GMP_LIMB_BITS == 16
{{{._mp_alloc = 0, ._mp_size = 16, ._mp_d = (mp_limb_t[]) {0x1920,0xb8b5,0x9c5,0xfd99,0xd1a8,0xb311,0xd4d8,0x9a8e,0x7f4c,0x1ad6,0xeba7,0xb78,0xe77,0xa59b,0xe5bc,0x11f7}}}}
#elif GMP_LIMB_BITS == 32
{{{._mp_alloc = 0, ._mp_size = 8, ._mp_d = (mp_limb_t[]) {0xb8b51920,0xfd9909c5,0xb311d1a8,0x9a8ed4d8,0x1ad67f4c,0xb78eba7,0xa59b0e77,0x11f7e5bc}}}}
#elif GMP_LIMB_BITS == 64
{{{._mp_alloc = 0, ._mp_size = 4, ._mp_d = (mp_limb_t[]) {0xfd9909c5b8b51920,0x9a8ed4d8b311d1a8,0xb78eba71ad67f4c,0x11f7e5bca59b0e77}}}}
#endif
, {{{
#if 0
#elif GMP_LIMB_BITS == 16
...
#if 0
#elif GMP_LIMB_BITS == 16
{{{._mp_alloc = 0, ._mp_size = 16, ._mp_d = (mp_limb_t[]) {0x8c90,0xdc5a,0x84e2,0x7ecc,0xe8d4,0x5988,0x6a6c,0x4d47,0x3fa6,0x8d6b,0x75d3,0x85bc,0x873b,0x52cd,0xf2de,0x8fb}}}}
#elif GMP_LIMB_BITS == 32
{{{._mp_alloc = 0, ._mp_size = 8, ._mp_d = (mp_limb_t[]) {0xdc5a8c90,0x7ecc84e2,0x5988e8d4,0x4d476a6c,0x8d6b3fa6,0x85bc75d3,0x52cd873b,0x8fbf2de}}}}
#elif GMP_LIMB_BITS == 64
{{{._mp_alloc = 0, ._mp_size = 4, ._mp_d = (mp_limb_t[]) {0x7ecc84e2dc5a8c90,0x4d476a6c5988e8d4,0x85bc75d38d6b3fa6,0x8fbf2de52cd873b}}}}
#endif
, 
#if 0
#elif GMP_LIMB_BITS == 16
...
#if 0
#elif GMP_LIMB_BITS == 16
{{{._mp_alloc = 0, ._mp_size = -16, ._mp_d = (mp_limb_t[]) {0x11f9,0xfb19,0xfec2,0xe1f1,0xe7a6,0xf9f,0x607,0xc29,0x62c,0x571,0x5f1e,0x9ef8,0x6833,0x4daa,0x5706,0x7bc1}}}}
#elif GMP_LIMB_BITS == 32
{{{._mp_alloc = 0, ._mp_size = -8, ._mp_d = (mp_limb_t[]) {0xfb1911f9,0xe1f1fec2,0xf9fe7a6,0xc290607,0x571062c,0x9ef85f1e,0x4daa6833,0x7bc15706}}}}
#elif GMP_LIMB_BITS == 64
{{{._mp_alloc = 0, ._mp_size = -4, ._mp_d = (mp_limb_t[]) {0xe1f1fec2fb1911f9,0xc2906070f9fe7a6,0x9ef85f1e0571062c,0x7bc157064daa6833}}}}
#endif
, 
#if 0
#elif GMP_LIMB_BITS == 16
...
#if 0
#elif GMP_LIMB_BITS == 16
{{{._mp_alloc = 0, ._mp_size = -32, ._mp_d = (mp_limb_t[]) {0x8f6c,0x2df1,0x638e,0xe2e3,0x6ecb,0xaa5e,0x1866,0xef1d,0x3821,0xa3ab,0x2721,0x3107,0xaffc,0x377a,0x4bb0,0x86ee,0x616a,0xa7a5,0x5616,0x6a7a,0xa561,0x16a7,0x7a56,0x616a,0xa7a5,0x5616,0x6a7a,0xa561,0x16a7,0x7a56,0x616a,0xd}}}}
#elif GMP_LIMB_BITS == 32
{{{._mp_alloc = 0, ._mp_size = -16, ._mp_d = (mp_limb_t[]) {0x2df18f6c,0xe2e3638e,0xaa5e6ecb,0xef1d1866,0xa3ab3821,0x31072721,0x377aaffc,0x86ee4bb0,0xa7a5616a,0x6a7a5616,0x16a7a561,0x616a7a56,0x5616a7a5,0xa5616a7a,0x7a5616a7,0xd616a}}}}
#elif GMP_LIMB_BITS == 64
{{{._mp_alloc = 0, ._mp_size = -8, ._mp_d = (mp_limb_t[]) {0xe2e3638e2df18f6c,0xef1d1866aa5e6ecb,0x31072721a3ab3821,0x86ee4bb0377aaffc,0x6a7a5616a7a5616a,0x616a7a5616a7a561,0xa5616a7a5616a7a5,0xd616a7a5616a7}}}}
#endif
}, {
#if 0
#elif GMP_LIMB_BITS == 16
...
#if 0
#elif GMP_LIMB_BITS == 16
{{{._mp_alloc = 0, ._mp_size = 16, ._mp_d = (mp_limb_t[]) {0x696c,0x823e,0x85a8,0x5b9e,0x43db,0x5bd2,0x5e0b,0x9a1b,0x98f2,0x2445,0x26ef,0xbb9b,0x93b7,0xd9d4,0x2ed3,0x8c}}}}
#elif GMP_LIMB_BITS == 32
{{{._mp_alloc = 0, ._mp_size = 8, ._mp_d = (mp_limb_t[]) {0x823e696c,0x5b9e85a8,0x5bd243db,0x9a1b5e0b,0x244598f2,0xbb9b26ef,0xd9d493b7,0x8c2ed3}}}}
#elif GMP_LIMB_BITS == 64
{{{._mp_alloc = 0, ._mp_size = 4, ._mp_d = (mp_limb_t[]) {0x5b9e85a8823e696c,0x9a1b5e0b5bd243db,0xbb9b26ef244598f2,0x8c2ed3d9d493b7}}}}
#endif
}}}}, {
#if 0
#elif GMP_LIMB_BITS == 16
