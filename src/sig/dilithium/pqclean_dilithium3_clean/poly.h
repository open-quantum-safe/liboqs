...
void PQCLEAN_DILITHIUM3_CLEAN_poly_add(
    poly *c, const poly *a, const poly *b);
void PQCLEAN_DILITHIUM3_CLEAN_poly_sub(
    poly *c, const poly *a, const poly *b);
...
void PQCLEAN_DILITHIUM3_CLEAN_poly_pointwise_invmontgomery(
    poly *c, const poly *a, const poly *b);

void PQCLEAN_DILITHIUM3_CLEAN_poly_power2round(
    poly *a1, poly *a0, const poly *a);
void PQCLEAN_DILITHIUM3_CLEAN_poly_decompose(
    poly *a1, poly *a0, const poly *a);
uint32_t PQCLEAN_DILITHIUM3_CLEAN_poly_make_hint(
    poly *h, const poly *a0, const poly *a1);
void PQCLEAN_DILITHIUM3_CLEAN_poly_use_hint(
    poly *a, const poly *b, const poly *h);

int  PQCLEAN_DILITHIUM3_CLEAN_poly_chknorm(
    const poly *a, uint32_t B);
void PQCLEAN_DILITHIUM3_CLEAN_poly_uniform(
    poly *a,
    const uint8_t *seed,
    uint16_t nonce);
void PQCLEAN_DILITHIUM3_CLEAN_poly_uniform_eta(
    poly *a,
    const uint8_t *seed,
    uint16_t nonce);
void PQCLEAN_DILITHIUM3_CLEAN_poly_uniform_gamma1m1(
    poly *a,
