#ifndef PQCLEAN_DILITHIUM4_AVX2_API_H
#define PQCLEAN_DILITHIUM4_AVX2_API_H
...
#define PQCLEAN_DILITHIUM4_AVX2_CRYPTO_ALGNAME "Dilithium4"


int PQCLEAN_DILITHIUM4_AVX2_crypto_sign_keypair(
