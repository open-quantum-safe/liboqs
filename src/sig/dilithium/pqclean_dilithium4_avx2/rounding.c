...
/*************************************************
* Name:        PQCLEAN_DILITHIUM4_AVX2_decompose
*
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM4_AVX2_make_hint
*
...
**************************************************/
unsigned int PQCLEAN_DILITHIUM4_AVX2_make_hint(const uint32_t a0, const uint32_t a1) {
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM4_AVX2_use_hint
*
...
**************************************************/
uint32_t PQCLEAN_DILITHIUM4_AVX2_use_hint(const uint32_t a, const unsigned int hint) {
    uint32_t a0, a1;

    a1 = PQCLEAN_DILITHIUM4_AVX2_decompose(a, &a0);
    if (hint == 0) {
        return a1;
    }
    if (a0 > Q) {
