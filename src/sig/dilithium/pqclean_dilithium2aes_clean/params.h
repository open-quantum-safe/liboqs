#ifndef PQCLEAN_DILITHIUM2AES_CLEAN_PARAMS_H
#define PQCLEAN_DILITHIUM2AES_CLEAN_PARAMS_H
...
#define PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_BYTES (SEEDBYTES + L*POLYZ_PACKEDBYTES + POLYVECH_PACKEDBYTES)
