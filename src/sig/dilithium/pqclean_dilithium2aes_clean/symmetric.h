#ifndef PQCLEAN_DILITHIUM2AES_CLEAN_SYMMETRIC_H
#define PQCLEAN_DILITHIUM2AES_CLEAN_SYMMETRIC_H
#include "aes256ctr.h"
#include "fips202.h"
#include "params.h"
#include <stdint.h>
...
#define stream128_squeezeblocks(OUT, OUTBLOCKS, STATE) \
    PQCLEAN_DILITHIUM2AES_CLEAN_aes256ctr_squeezeblocks(OUT, OUTBLOCKS, STATE)
