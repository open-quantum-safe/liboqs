...
/*************************************************
* Name:        PQCLEAN_DILITHIUM5AES_CLEAN_montgomery_reduce
*
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM5AES_CLEAN_reduce32
*
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM5AES_CLEAN_caddq
*
...
/*************************************************
* Name:        PQCLEAN_DILITHIUM5AES_CLEAN_freeze
*
...
int32_t PQCLEAN_DILITHIUM5AES_CLEAN_freeze(int32_t a) {
    a = PQCLEAN_DILITHIUM5AES_CLEAN_reduce32(a);
    a = PQCLEAN_DILITHIUM5AES_CLEAN_caddq(a);
    return a;
}
