#ifndef PQCLEAN_DILITHIUM5AES_CLEAN_SYMMETRIC_H
#define PQCLEAN_DILITHIUM5AES_CLEAN_SYMMETRIC_H
#include "aes256ctr.h"
#include "fips202.h"
#include "params.h"
#include <stdint.h>
...
void PQCLEAN_DILITHIUM5AES_CLEAN_dilithium_aes256ctr_init(aes256ctr_ctx *state,
...
#define stream128_init(STATE, SEED, NONCE) \
    PQCLEAN_DILITHIUM5AES_CLEAN_dilithium_aes256ctr_init(STATE, SEED, NONCE)
