...
#define MQOM3_PARAM_LABEL "MQOM3-L3-gf16-fast-ot"
#define MQOM3_PARAM_KAT cat3_gf16_fast_ot
...
#error "mqom3_parameters_cat3_gf16_fast_ot.h included for a build that is not One-Tree (OT)"
#endif
...
/* h = ceil(log2(tau * N)) = 13 for tau=26, N=256 */
...
#define MQOM3_PARAM_LARGE_GGM_T_OPEN 186
#endif
...
#define MQOM3_PARAM_GRIND_WTOT 11.0
#endif
...
#define MQOM3_PARAM_GRIND_MEAN_TRIALS 1024
#endif
