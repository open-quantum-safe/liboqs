...
#define MQOM3_PARAM_LABEL "MQOM3-L3-gf2-shorter-ot"
#define MQOM3_PARAM_KAT cat3_gf2_shorter_ot
...
#error "mqom3_parameters_cat3_gf2_shorter_ot.h included for a build that is not One-Tree (OT)"
#endif
...
/* h = ceil(log2(tau * N)) = 17 for tau=17, N=4096 */
...
#define MQOM3_PARAM_LARGE_GGM_T_OPEN 170
#endif
...
#define MQOM3_PARAM_GRIND_WTOT 14.5
#endif
...
#define MQOM3_PARAM_GRIND_MEAN_TRIALS 11585
#endif
