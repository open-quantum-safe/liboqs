...
#define MQOM3_PARAM_LABEL "MQOM3-L1-gf16-fast-ot"
#define MQOM3_PARAM_KAT cat1_gf16_fast_ot
...
#error "mqom3_parameters_cat1_gf16_fast_ot.h included for a build that is not One-Tree (OT)"
#endif
...
/* h = ceil(log2(tau * N)) = 13 for tau=17, N=256 */
...
#define MQOM3_PARAM_LARGE_GGM_T_OPEN 119
#endif
...
#define MQOM3_PARAM_GRIND_WTOT 10.8
#endif
...
#define MQOM3_PARAM_GRIND_MEAN_TRIALS 891
#endif
