...
#define MQOM3_PARAM_LABEL "MQOM3-L3-gf16-short-ot"
#define MQOM3_PARAM_KAT cat3_gf16_short_ot
...
#error "mqom3_parameters_cat3_gf16_short_ot.h included for a build that is not One-Tree (OT)"
#endif
...
/* h = ceil(log2(tau * N)) = 16 for tau=19, N=2048 */
...
#define MQOM3_PARAM_LARGE_GGM_T_OPEN 175
#endif
