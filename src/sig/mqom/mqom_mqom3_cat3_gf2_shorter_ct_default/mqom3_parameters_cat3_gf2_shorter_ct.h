...
#define MQOM3_PARAM_LABEL "MQOM3-L3-gf2-shorter-ct"
#define MQOM3_PARAM_KAT cat3_gf2_shorter_ct
...
#error "mqom3_parameters_cat3_gf2_shorter_ct.h included for a build that is not Correlated-Tree (CT)"
#endif
