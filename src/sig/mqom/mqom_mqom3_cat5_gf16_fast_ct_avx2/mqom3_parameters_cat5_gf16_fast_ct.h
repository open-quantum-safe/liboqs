...
#define MQOM3_PARAM_LABEL "MQOM3-L5-gf16-fast-ct"
#define MQOM3_PARAM_KAT cat5_gf16_fast_ct
...
#error "mqom3_parameters_cat5_gf16_fast_ct.h included for a build that is not Correlated-Tree (CT)"
#endif
