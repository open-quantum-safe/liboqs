...
#define MQOM3_PARAM_LABEL "MQOM3-L5-gf16-short-ot"
#define MQOM3_PARAM_KAT cat5_gf16_short_ot
...
#error "mqom3_parameters_cat5_gf16_short_ot.h included for a build that is not One-Tree (OT)"
#endif
...
/* h = ceil(log2(tau * N)) = 16 for tau=25, N=2048 */
...
#define MQOM3_PARAM_LARGE_GGM_T_OPEN 238
#endif
...
#define MQOM3_PARAM_GRIND_WTOT 11.9
#endif
...
#define MQOM3_PARAM_GRIND_MEAN_TRIALS 1911
#endif
