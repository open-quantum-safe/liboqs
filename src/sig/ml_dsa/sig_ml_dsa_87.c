...
extern int PQCP_MLDSA_NATIVE_MLDSA87_C_keypair_internal(uint8_t *pk, uint8_t *sk, const uint8_t *seed);
...
extern int PQCP_MLDSA_NATIVE_MLDSA87_X86_64_keypair_internal(uint8_t *pk, uint8_t *sk, const uint8_t *seed);
...
extern int PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_keypair_internal(uint8_t *pk, uint8_t *sk, const uint8_t *seed);
...
OQS_API OQS_STATUS OQS_SIG_ml_dsa_87_keypair_derand(uint8_t *public_key, uint8_t *secret_key, const uint8_t *seed) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_AVX2) && OQS_CPU_has_extension(OQS_CPU_EXT_BMI2) && OQS_CPU_has_extension(OQS_CPU_EXT_POPCNT)) {
		...
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_X86_64_keypair_internal(public_key, secret_key, seed);
#if defined(OQS_DIST_BUILD)
	} else {
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_keypair_internal(public_key, secret_key, seed);
	}
#endif /* OQS_DIST_BUILD */
...
#endif /* OQS_DIST_BUILD */
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_keypair_internal(public_key, secret_key, seed);
#if defined(OQS_DIST_BUILD)
	} else {
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_keypair_internal(public_key, secret_key, seed);
	}
