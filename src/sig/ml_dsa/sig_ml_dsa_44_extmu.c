...
extern int PQCP_MLDSA_NATIVE_MLDSA44_C_signature_extmu_oqs(uint8_t *sig, size_t *siglen, const uint8_t *m, const uint8_t *sk);
extern int PQCP_MLDSA_NATIVE_MLDSA44_C_verify_extmu_oqs(const uint8_t *sig, size_t siglen, const uint8_t *m, const uint8_t *pk);
...
extern int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_signature_extmu_oqs(uint8_t *sig, size_t *siglen, const uint8_t *m, const uint8_t *sk);
extern int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_verify_extmu_oqs(const uint8_t *sig, size_t siglen, const uint8_t *m, const uint8_t *pk);
#endif
...
extern int PQCP_MLDSA_NATIVE_MLDSA44_AARCH64_signature_extmu_oqs(uint8_t *sig, size_t *siglen, const uint8_t *m, const uint8_t *sk);
extern int PQCP_MLDSA_NATIVE_MLDSA44_AARCH64_verify_extmu_oqs(const uint8_t *sig, size_t siglen, const uint8_t *m, const uint8_t *pk);
#endif
...
OQS_API OQS_STATUS OQS_SIG_ml_dsa_44_extmu_sign(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len, const uint8_t *secret_key) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_AVX2) && OQS_CPU_has_extension(OQS_CPU_EXT_BMI2) && OQS_CPU_has_extension(OQS_CPU_EXT_POPCNT)) {
#endif /* OQS_DIST_BUILD */
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_X86_64_signature_extmu_oqs(signature, signature_len, message, secret_key);
#if defined(OQS_DIST_BUILD)
	} else {
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_C_signature_extmu_oqs(signature, signature_len, message, secret_key);
	}
#endif /* OQS_DIST_BUILD */
#elif defined(OQS_ENABLE_SIG_ml_dsa_44_extmu_aarch64)
#if defined(OQS_DIST_BUILD)
	if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_NEON)) {
#endif /* OQS_DIST_BUILD */
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_AARCH64_signature_extmu_oqs(signature, signature_len, message, secret_key);
#if defined(OQS_DIST_BUILD)
	} else {
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_C_signature_extmu_oqs(signature, signature_len, message, secret_key);
	}
...
OQS_API OQS_STATUS OQS_SIG_ml_dsa_44_extmu_verify(const uint8_t *message, size_t message_len, const uint8_t *signature, size_t signature_len, const uint8_t *public_key) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_AVX2) && OQS_CPU_has_extension(OQS_CPU_EXT_BMI2) && OQS_CPU_has_extension(OQS_CPU_EXT_POPCNT)) {
#endif /* OQS_DIST_BUILD */
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_X86_64_verify_extmu_oqs(signature, signature_len, message, public_key);
#if defined(OQS_DIST_BUILD)
	} else {
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_C_verify_extmu_oqs(signature, signature_len, message, public_key);
	}
#endif /* OQS_DIST_BUILD */
#elif defined(OQS_ENABLE_SIG_ml_dsa_44_extmu_aarch64)
#if defined(OQS_DIST_BUILD)
	if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_NEON)) {
#endif /* OQS_DIST_BUILD */
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_AARCH64_verify_extmu_oqs(signature, signature_len, message, public_key);
#if defined(OQS_DIST_BUILD)
	} else {
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA44_C_verify_extmu_oqs(signature, signature_len, message, public_key);
	}
