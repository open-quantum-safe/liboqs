...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_tweak_constants(
    harakactx *state,
    ...
    if (sk_seed != NULL) {
        PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_S(buf, 40 * 16, sk_seed, seed_length, state);
    ...
    PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_S(buf, 40 * 16, pk_seed, seed_length, state);
...
static void haraka_S_absorb(unsigned char *s,
    ...
    while (mlen >= HARAKAS_RATE) {
        ...
        PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka512_perm(s, s, state);
        mlen -= HARAKAS_RATE;
        m += HARAKAS_RATE;
    }
...
static void haraka_S_absorb4x(unsigned char *s,
    ...
    while (mlen >= HARAKAS_RATE) {
        ...
        PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka512_perm_x4(s, s, state);
        mlen -= HARAKAS_RATE;
        m0 += HARAKAS_RATE;
        m1 += HARAKAS_RATE;
        m2 += HARAKAS_RATE;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_S_inc_init(uint8_t *s_inc) {
    size_t i;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_S_inc_absorb(uint8_t *s_inc, const uint8_t *m, size_t mlen, const harakactx *state) {
    size_t i;
    ...
    while (mlen + s_inc[64] >= HARAKAS_RATE) {
        ...
        PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka512_perm(s_inc, s_inc, state);
    }
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_S_inc_finalize(uint8_t *s_inc) {
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_S_inc_squeeze(uint8_t *out, size_t outlen, uint8_t *s_inc, const harakactx *state) {
    size_t i;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_S(unsigned char *out, unsigned long long outlen,
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka_Sx4(unsigned char *out0,
        unsigned char *out1,
        unsigned char *out2,
        unsigned char *out3,
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka512_perm(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[4], tmp;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka512_perm_x4(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[4][4], tmp;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka512(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[4], tmp;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka512x4(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[4][4], tmp;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka256(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[2], tmp;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka256x4(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[4][2], tmp;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka256_sk(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[2], tmp;
...
void PQCLEAN_SPHINCSHARAKA128SROBUST_AESNI_haraka256_skx4(unsigned char *out, const unsigned char *in, const harakactx *state) {
    u128 s[4][2], tmp;
