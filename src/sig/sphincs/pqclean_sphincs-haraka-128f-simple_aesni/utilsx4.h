#ifndef PQCLEAN_SPHINCSHARAKA128FSIMPLE_AESNI_UTILSX4_H
#define PQCLEAN_SPHINCSHARAKA128FSIMPLE_AESNI_UTILSX4_H
 ...
 */
void PQCLEAN_SPHINCSHARAKA128FSIMPLE_AESNI_treehashx4_FORS_HEIGHT(unsigned char *rootx4,
