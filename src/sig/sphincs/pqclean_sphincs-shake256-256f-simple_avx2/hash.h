#ifndef PQCLEAN_SPHINCSSHAKE256256FSIMPLE_AVX2_HASH_H
#define PQCLEAN_SPHINCSSHAKE256256FSIMPLE_AVX2_HASH_H
...
void PQCLEAN_SPHINCSSHAKE256256FSIMPLE_AVX2_destroy_hash_function(hash_state *hash_state_seeded);
