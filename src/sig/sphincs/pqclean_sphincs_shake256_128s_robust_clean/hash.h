#ifndef PQCLEAN_SPHINCSSHAKE256128SROBUST_CLEAN_HASH_H
#define PQCLEAN_SPHINCSSHAKE256128SROBUST_CLEAN_HASH_H
...
void PQCLEAN_SPHINCSSHAKE256128SROBUST_CLEAN_destroy_hash_function(hash_state *hash_state_seeded);
