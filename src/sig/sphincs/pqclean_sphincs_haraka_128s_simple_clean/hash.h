#ifndef PQCLEAN_SPHINCSHARAKA128SSIMPLE_CLEAN_HASH_H
#define PQCLEAN_SPHINCSHARAKA128SSIMPLE_CLEAN_HASH_H
...
void PQCLEAN_SPHINCSHARAKA128SSIMPLE_CLEAN_destroy_hash_function(hash_state *hash_state_seeded);
