...
void PQCLEAN_SPHINCSSHA256128SSIMPLE_AVX2_transpose(u256 s[8]);
void PQCLEAN_SPHINCSSHA256128SSIMPLE_AVX2_sha256_init_frombytes_x8(sha256ctxx8 *ctx, const uint8_t *s, unsigned long long msglen);
void PQCLEAN_SPHINCSSHA256128SSIMPLE_AVX2_sha256_init8x(sha256ctxx8 *ctx);
void PQCLEAN_SPHINCSSHA256128SSIMPLE_AVX2_sha256_update8x(sha256ctxx8 *ctx,
...
void PQCLEAN_SPHINCSSHA256128SSIMPLE_AVX2_sha256_final8x(sha256ctxx8 *ctx,
        unsigned char *out0,
        unsigned char *out1,
        unsigned char *out2,
        unsigned char *out3,
...
void PQCLEAN_SPHINCSSHA256128SSIMPLE_AVX2_sha256_transform8x(sha256ctxx8 *ctx, const unsigned char *data);

void PQCLEAN_SPHINCSSHA256128SSIMPLE_AVX2_sha256_clone_statex8(sha256ctxx8 *outctx, const sha256ctxx8 *inctx);
