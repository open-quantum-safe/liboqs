#ifndef PQCLEAN_SPHINCSHARAKA192SROBUST_AESNI_UTILSX4_H
#define PQCLEAN_SPHINCSHARAKA192SROBUST_AESNI_UTILSX4_H
 ...
 */
void PQCLEAN_SPHINCSHARAKA192SROBUST_AESNI_treehashx4_FORS_HEIGHT(unsigned char *rootx4,
