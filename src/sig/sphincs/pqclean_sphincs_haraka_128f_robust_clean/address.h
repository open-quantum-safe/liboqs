#ifndef PQCLEAN_SPHINCSHARAKA128FROBUST_CLEAN_ADDRESS_H
#define PQCLEAN_SPHINCSHARAKA128FROBUST_CLEAN_ADDRESS_H

#include <stdint.h>

#define PQCLEAN_SPHINCSHARAKA128FROBUST_CLEAN_ADDR_TYPE_WOTS 0
#define PQCLEAN_SPHINCSHARAKA128FROBUST_CLEAN_ADDR_TYPE_WOTSPK 1
#define PQCLEAN_SPHINCSHARAKA128FROBUST_CLEAN_ADDR_TYPE_HASHTREE 2
#define PQCLEAN_SPHINCSHARAKA128FROBUST_CLEAN_ADDR_TYPE_FORSTREE 3
#define PQCLEAN_SPHINCSHARAKA128FROBUST_CLEAN_ADDR_TYPE_FORSPK 4
