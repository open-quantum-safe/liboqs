...
// clang-format off
#define FAEST_LAMBDA FAEST_128_LAMBDA
#define FAEST_NK (FAEST_LAMBDA / 32)
#define FAEST_R FAEST_128S_R
...
#define bf_add_inplace bf128_add_inplace
#define bf_mul bf128_mul
#define bf_mul_inplace bf128_mul_inplace
#define bf_mul_bit bf128_mul_bit
#define bf_square bf128_square
#define bf_byte_combine bf128_byte_combine
#define bf_byte_combine_bits bf128_byte_combine_bits
#define bf_byte_combine_sq bf128_byte_combine_sq
#define bf_sq_bit bf128_sq_bit
#define bf_sq_bit_inplace bf128_sq_bit_inplace
#define bf_sum_poly_bits bf128_sum_poly_bits
#define BF_NUM_BYTES BF128_NUM_BYTES
#define BF_ALIGN BF128_ALIGN

#define zk_hash_7_ctx zk_hash_128_7_ctx
#define zk_hash_7_finalize zk_hash_128_7_finalize
#define zk_hash_7_init zk_hash_128_7_init
#define zk_hash_7_raise_and_update zk_hash_128_7_raise_and_update
#define zk_hash_7_update zk_hash_128_7_update
#define zk_hash_ctx zk_hash_128_ctx
#define zk_hash_finalize zk_hash_128_finalize
#define zk_hash_init zk_hash_128_init
#define zk_hash_update zk_hash_128_update

#define aes_prover aes_128_prover
#define aes_verifier aes_128_verifier

static_assert(D_ZK == 7, "Invalid assumptions.");

static_assert(FAEST_LAMBDA == FAEST_128S_LAMBDA, "Invalid parameters");
...
static_assert(FAEST_R == FAEST_EM_128S_R, "Invalid parameters");
