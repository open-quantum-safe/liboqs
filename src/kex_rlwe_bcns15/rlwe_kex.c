...
void oqs_kex_rlwe_bcns15_generate_keypair(
    const uint32_t *a, uint32_t s[1024],
    uint32_t b[1024],
...
#endif
	oqs_kex_rlwe_bcns15_a_times_s_plus_e(b, a, s, e,
	                                     ctx);
	rlwe_memset_volatile(e, 0,
	                     1024 * sizeof(uint32_t));
}

void oqs_kex_rlwe_bcns15_compute_key_alice(
    const uint32_t b[1024],
    const uint32_t s[1024], const uint64_t c[16],
    uint64_t k[16],
    struct oqs_kex_rlwe_bcns15_fft_ctx *ctx) {
	uint32_t w[1024];
...
#endif
	rlwe_memset_volatile(w, 0,
	                     1024 * sizeof(uint32_t));
}

void oqs_kex_rlwe_bcns15_compute_key_bob(
    const uint32_t b[1024],
    const uint32_t s[1024], uint64_t c[16],
    uint64_t k[16],
    struct oqs_kex_rlwe_bcns15_fft_ctx *ctx,
    OQS_RAND *rand) {
	uint32_t v[1024];
...
#endif
	oqs_kex_rlwe_bcns15_a_times_s_plus_e(v, b, s,
	                                     eprimeprime, ctx);
#if CONSTANT_TIME
...
#endif
	rlwe_memset_volatile(v, 0,
	                     1024 * sizeof(uint32_t));
	rlwe_memset_volatile(eprimeprime, 0,
	                     1024 * sizeof(uint32_t));
}
