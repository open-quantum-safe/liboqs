 ...
 * @param forEncryption  1 if key schedule is for encryption, 0 if for
 * decryption.
 */
 ...
 * @param plaintext_len Length on the plaintext in bytes. Must be a multiple of
 * 16.
 * @param key           Key to be used for encryption.
 * @param ciphertext    Pointer to a block of memory which >= in size to the
 * plaintext block. The result will be written here.
 */
 ...
 * @param ciphertext_len Length on the ciphertext in bytes. Must be a multiple
 * of 16.
 * @param key            Key to be used for encryption.
 * @param ciphertext     Pointer to a block of memory which >= in size to the
 * ciphertext block. The result will be written here.
 */
