...
__inline void oqs_sidh_cln16_fpcopy751(const oqs_sidh_cln16_felm_t a, oqs_sidh_cln16_felm_t c)
...
static __inline unsigned int is_felm_zero(const oqs_sidh_cln16_felm_t x)
...
static __inline unsigned int is_felm_even(const oqs_sidh_cln16_felm_t x)
{ // Is x even? return 1 (TRUE) if condition is true, 0 (FALSE) otherwise.
    return (unsigned int)((x[0] & 1) ^ 1);
}


static __inline unsigned int is_felm_lt(const oqs_sidh_cln16_felm_t x, const oqs_sidh_cln16_felm_t y)
...
__inline unsigned int oqs_sidh_cln16_mp_sub(const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords)
...
__inline unsigned int oqs_sidh_cln16_mp_add(const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords)
...
__inline void oqs_sidh_cln16_mp_add751(const digit_t* a, const digit_t* b, digit_t* c)
...
__inline void oqs_sidh_cln16_mp_add751x2(const digit_t* a, const digit_t* b, digit_t* c)
...
void oqs_sidh_cln16_fpmul751_mont(const oqs_sidh_cln16_felm_t ma, const oqs_sidh_cln16_felm_t mb, oqs_sidh_cln16_felm_t mc)
...
static __inline void fpinv751_mont_bingcd_partial(const oqs_sidh_cln16_felm_t a, oqs_sidh_cln16_felm_t x1, unsigned int* k)
{ // Partial Montgomery inversion in GF(p751) via the binary GCD algorithm.
	...
	oqs_sidh_cln16_fpzero751(x1); x1[0] = 1;
...
__inline void oqs_sidh_cln16_fp2add751(const oqs_sidh_cln16_f2elm_t a, const oqs_sidh_cln16_f2elm_t b, oqs_sidh_cln16_f2elm_t c)           
...
__inline void oqs_sidh_cln16_fp2sub751(const oqs_sidh_cln16_f2elm_t a, const oqs_sidh_cln16_f2elm_t b, oqs_sidh_cln16_f2elm_t c)          
...
__inline void oqs_sidh_cln16_inv_Fp2_cycl(oqs_sidh_cln16_f2elm_t a)
...
void oqs_sidh_cln16_Montgomery_inversion_mod_order_bingcd(const digit_t* a, digit_t* c, const digit_t* order, const digit_t* Montgomery_rprime, const digit_t* Montgomery_Rprime)
