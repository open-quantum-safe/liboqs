...
*
*
* Abstract: core functions over GF(p751^2) and field operations over the prime
*p751
*
*********************************************************************************************/
...
__inline void oqs_sidh_cln16_fpcopy751(oqs_sidh_cln16_felm_t a,
...
UNUSED static __inline unsigned int is_felm_zero(oqs_sidh_cln16_felm_t x) {
  ...
  // NOTE: this function does not run in constant-time so it can only be used in
  // functions
...
UNUSED static __inline unsigned int is_felm_lt(oqs_sidh_cln16_felm_t x,
...
__inline unsigned int oqs_sidh_cln16_mp_sub(digit_t *a, digit_t *b, digit_t *c,
                                            unsigned int nwords) {
  // Multiprecision subtraction, c = a-b, where lng(a) = lng(b) = nwords.
  // Returns the borrow bit
...
__inline unsigned int oqs_sidh_cln16_mp_add(digit_t *a, digit_t *b, digit_t *c,
                                            unsigned int nwords) {
  // Multiprecision addition, c = a+b, where lng(a) = lng(b) = nwords. Returns
  // the carry bit
...
void oqs_sidh_cln16_fpmul751_mont(oqs_sidh_cln16_felm_t ma,
                                  oqs_sidh_cln16_felm_t mb,
...
__inline void oqs_sidh_cln16_fp2add751(oqs_sidh_cln16_f2elm_t a,
...
__inline void oqs_sidh_cln16_fp2sub751(oqs_sidh_cln16_f2elm_t a,
                                       oqs_sidh_cln16_f2elm_t b,
                                       oqs_sidh_cln16_f2elm_t c) {
...
void oqs_sidh_cln16_fp2mul751_mont(oqs_sidh_cln16_f2elm_t a,
                                   oqs_sidh_cln16_f2elm_t b,
                                   oqs_sidh_cln16_f2elm_t c) {
  // GF(p751^2) multiplication using Montgomery arithmetic, c = a*b in
  // GF(p751^2)
...
void oqs_sidh_cln16_from_fp2mont(oqs_sidh_cln16_f2elm_t ma,
                                 oqs_sidh_cln16_f2elm_t c) {
  // Conversion of a GF(p751^2) element from Montgomery representation to
