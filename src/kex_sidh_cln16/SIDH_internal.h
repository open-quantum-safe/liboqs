...
typedef struct { oqs_sidh_cln16_f2elm_t x; oqs_sidh_cln16_f2elm_t y; } oqs_sidh_cln16_point_affine;                // Point representation in affine coordinates on Montgomery curve.
typedef oqs_sidh_cln16_point_affine oqs_sidh_cln16_point_t[1]; 
        
typedef struct { oqs_sidh_cln16_f2elm_t X; oqs_sidh_cln16_f2elm_t Z; } oqs_sidh_cln16_point_proj;                  // Point representation in projective XZ Montgomery coordinates.
typedef oqs_sidh_cln16_point_proj oqs_sidh_cln16_point_proj_t[1]; 
        
typedef struct { oqs_sidh_cln16_f2elm_t X; oqs_sidh_cln16_f2elm_t Y; oqs_sidh_cln16_f2elm_t Z; } oqs_sidh_cln16_point_full_proj;  // Point representation in projective XYZ Montgomery coordinates.
typedef oqs_sidh_cln16_point_full_proj oqs_sidh_cln16_point_full_proj_t[1]; 
    
typedef struct { oqs_sidh_cln16_f2elm_t X2; oqs_sidh_cln16_f2elm_t XZ; oqs_sidh_cln16_f2elm_t Z2; oqs_sidh_cln16_f2elm_t YZ; } oqs_sidh_cln16_point_ext_proj;
...
typedef struct { oqs_sidh_cln16_felm_t x; oqs_sidh_cln16_felm_t y; } oqs_sidh_cln16_point_basefield_affine;        // Point representation in affine coordinates on Montgomery curve over the base field.
typedef oqs_sidh_cln16_point_basefield_affine oqs_sidh_cln16_point_basefield_t[1];  
        
typedef struct { oqs_sidh_cln16_felm_t X; oqs_sidh_cln16_felm_t Z; } oqs_sidh_cln16_point_basefield_proj;          // Point representation in projective XZ Montgomery coordinates over the base field.
