...
#if defined(OQS_ENABLE_KEM_threebears_mamabear_ephem)
...
extern int PQCLEAN_MAMABEAREPHEM_CLEAN_crypto_kem_keypair(unsigned char *pk, unsigned char *sk);
extern int PQCLEAN_MAMABEAREPHEM_CLEAN_crypto_kem_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk);
extern int PQCLEAN_MAMABEAREPHEM_CLEAN_crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
