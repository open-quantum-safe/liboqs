...
int PQCLEAN_LIGHTSABER_AARCH64_crypto_kem_keypair(unsigned char *pk, unsigned char *sk) {
    int i;
...
int PQCLEAN_LIGHTSABER_AARCH64_crypto_kem_enc(unsigned char *c, unsigned char *k, const unsigned char *pk) {
...
int PQCLEAN_LIGHTSABER_AARCH64_crypto_kem_dec(unsigned char *k, const unsigned char *c, const unsigned char *sk) {
    int i, fail;
