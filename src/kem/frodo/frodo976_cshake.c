...
*
* Abstract: functions for Frodo-976
...
#define crypto_kem_keypair OQS_KEM_frodo_976_cshake_keypair
#define crypto_kem_enc OQS_KEM_frodo_976_cshake_encaps
#define crypto_kem_dec OQS_KEM_frodo_976_cshake_decaps
