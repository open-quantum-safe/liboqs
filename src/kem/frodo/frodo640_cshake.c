...
#define crypto_kem_keypair OQS_KEM_frodo_640_cshake_keypair
#define crypto_kem_enc OQS_KEM_frodo_640_cshake_encaps
#define crypto_kem_dec OQS_KEM_frodo_640_cshake_decaps
