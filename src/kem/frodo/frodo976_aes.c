...
#define crypto_kem_keypair OQS_KEM_frodo_976_aes_keypair
#define crypto_kem_enc OQS_KEM_frodo_976_aes_encaps
#define crypto_kem_dec OQS_KEM_frodo_976_aes_decaps
