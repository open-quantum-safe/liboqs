...
#endif /* OQS_ENABLE_KEM_ml_kem_512_aarch64 */
...
#endif /* OQS_ENABLE_KEM_ml_kem_512_x86_64 */

#if defined(OQS_ENABLE_KEM_ml_kem_512_cuda) && defined(OQS_USE_CUPQC)
...
#endif /* OQS_ENABLE_KEM_ml_kem_512_cuda && OQS_USE_CUPQC */

#if defined(OQS_ENABLE_KEM_ml_kem_512_icicle_cuda) && defined(OQS_USE_ICICLE)
...
#endif /* OQS_ENABLE_KEM_ml_kem_512_icicle_cuda && OQS_USE_ICICLE */
...
#elif defined(OQS_ENABLE_KEM_ml_kem_512_cuda) && defined(OQS_USE_CUPQC)
...
#elif defined(OQS_ENABLE_KEM_ml_kem_512_icicle_cuda) && defined(OQS_USE_ICICLE)
