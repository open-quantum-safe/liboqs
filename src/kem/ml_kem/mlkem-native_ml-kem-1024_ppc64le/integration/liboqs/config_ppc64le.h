 ...
 *****************************************************************************/
#if MLKEM_K == 2
#define MLK_NAMESPACE_PREFIX PQCP_MLKEM_NATIVE_MLKEM512_PPC64LE
#elif MLKEM_K == 3
#define MLK_NAMESPACE_PREFIX PQCP_MLKEM_NATIVE_MLKEM768_PPC64LE
#elif MLKEM_K == 4
#define MLK_NAMESPACE_PREFIX PQCP_MLKEM_NATIVE_MLKEM1024_PPC64LE
#endif
