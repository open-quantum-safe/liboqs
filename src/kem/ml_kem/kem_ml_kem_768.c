...
#endif /* OQS_ENABLE_KEM_ml_kem_768_aarch64 */
...
#if defined(OQS_ENABLE_KEM_ml_kem_768_cuda) && defined(OQS_USE_CUPQC)
...
#endif /* OQS_ENABLE_KEM_ml_kem_768_cuda && OQS_USE_CUPQC */

#if defined(OQS_ENABLE_KEM_ml_kem_768_icicle_cuda) && defined(OQS_USE_ICICLE)
...
#endif /* OQS_ENABLE_KEM_ml_kem_768_icicle_cuda && OQS_USE_ICICLE */
...
#elif defined(OQS_ENABLE_KEM_ml_kem_768_cuda) && defined(OQS_USE_CUPQC)
...
#elif defined(OQS_ENABLE_KEM_ml_kem_768_icicle_cuda) && defined(OQS_USE_ICICLE)
