...
int icicle_ml_kem_768_keypair(uint8_t *pk, uint8_t *sk) {
    ...
    return (int)icicle::pqc::ml_kem::keygen<icicle::pqc::ml_kem::Kyber768Params>((std::byte*)coins, config, (std::byte*)pk, (std::byte*)sk);
}
...
int icicle_ml_kem_768_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk) {
    ...
    icicle::pqc::ml_kem::MlKemConfig config;
    return (int)icicle::pqc::ml_kem::encapsulate<icicle::pqc::ml_kem::Kyber768Params>((std::byte*)coins, (std::byte*)pk, config, (std::byte*)ct, (std::byte*)ss);
}
...
int icicle_ml_kem_768_dec(uint8_t *ss, const uint8_t *ct, const uint8_t *sk) {
    ...
    icicle::pqc::ml_kem::MlKemConfig config;
    return (int)icicle::pqc::ml_kem::decapsulate<icicle::pqc::ml_kem::Kyber768Params>((std::byte*)sk, (std::byte*)ct, config, (std::byte*)ss);
}
}
