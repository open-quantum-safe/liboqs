...
OQS_KEM *OQS_KEM_ml_kem_1024_ipd_new(void) {
	...
	kem->length_keypair_coins = OQS_KEM_ml_kem_1024_ipd_length_keypair_coins;
	kem->length_encaps_coins = OQS_KEM_ml_kem_1024_ipd_length_encaps_coins;
...
extern int pqcrystals_ml_kem_1024_ipd_avx2_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
extern int pqcrystals_ml_kem_1024_ipd_avx2_keypair(uint8_t *pk, uint8_t *sk);
extern int pqcrystals_ml_kem_1024_ipd_avx2_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
...
OQS_API OQS_STATUS OQS_KEM_ml_kem_1024_ipd_keypair_derand(uint8_t *public_key, uint8_t *secret_key, const uint8_t *coins) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_AVX2) && OQS_CPU_has_extension(OQS_CPU_EXT_BMI2) && OQS_CPU_has_extension(OQS_CPU_EXT_POPCNT)) {
		...
		return (OQS_STATUS) pqcrystals_ml_kem_1024_ipd_avx2_keypair_derand(public_key, secret_key, coins);
#if defined(OQS_DIST_BUILD)
	} else {
		return (OQS_STATUS) pqcrystals_ml_kem_1024_ipd_ref_keypair_derand(public_key, secret_key, coins);
	}
#endif /* OQS_DIST_BUILD */
#else
	return (OQS_STATUS) pqcrystals_ml_kem_1024_ipd_ref_keypair_derand(public_key, secret_key, coins);
