...
#if defined(OQS_ENABLE_KEM_hqc_rmrs_192)

OQS_KEM *OQS_KEM_hqc_rmrs_192_new() {

	OQS_KEM *kem = malloc(sizeof(OQS_KEM));
	if (kem == NULL) {
		return NULL;
	}
	kem->method_name = OQS_KEM_alg_hqc_rmrs_192;
	kem->alg_version = "2020-05-29";

	kem->claimed_nist_level = 3;
	kem->ind_cca = true;

	kem->length_public_key = OQS_KEM_hqc_rmrs_192_length_public_key;
	kem->length_secret_key = OQS_KEM_hqc_rmrs_192_length_secret_key;
	kem->length_ciphertext = OQS_KEM_hqc_rmrs_192_length_ciphertext;
	kem->length_shared_secret = OQS_KEM_hqc_rmrs_192_length_shared_secret;

	kem->keypair = OQS_KEM_hqc_rmrs_192_keypair;
	kem->encaps = OQS_KEM_hqc_rmrs_192_encaps;
	kem->decaps = OQS_KEM_hqc_rmrs_192_decaps;
...
#if defined(OQS_ENABLE_KEM_hqc_rmrs_192_avx2)
