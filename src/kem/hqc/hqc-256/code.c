 ...
 */
void HQC256_code_encode(uint64_t *em, const uint64_t *m) {
    uint64_t tmp[HQC256_VEC_N1_SIZE_64] = {0};

    HQC256_reed_solomon_encode(tmp, m);
 ...
 */
void HQC256_code_decode(uint64_t *m, const uint64_t *em) {
    uint64_t tmp[HQC256_VEC_N1_SIZE_64] = {0};
