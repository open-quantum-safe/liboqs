...
/*
  ...
  #define PARAM_FFT                             The additive FFT takes a 2^PARAM_FFT polynomial as input
                                                We use the FFT to compute the roots of sigma, whose degree if PARAM_DELTA=22
                                                The smallest power of 2 greater than 22+1 is 32=2^5
...
#define PARAM_N                                 38923
#define PARAM_N1                                76
#define PARAM_N2                                512
#define PARAM_N1N2                              38912
...
#define UTILS_REJECTION_THRESHOLD               16775813
...
#define PARAM_G                                 45
#define PARAM_FFT                               5
#define RS_POLY_COEFS               36,248,168,57,215,30,166,88,196,173,61,214,100,134,168,41,57,216,254,252,68,194,32,234,205,39,99,6,66,127,53,221,1,17,7,219,161,30,173,30,51,95,58,65,1

#define RED_MASK                                0x7ffUL
