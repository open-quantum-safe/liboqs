...
void PQCLEAN_HQCRMRS128_AVX2_hqc_pke_keygen(unsigned char *pk, unsigned char *sk) {
    ...
    PQCLEAN_HQCRMRS128_AVX2_vect_mul(s, y, h);
    PQCLEAN_HQCRMRS128_AVX2_vect_add(s, x, s, VEC_N_256_SIZE_64);
...
void PQCLEAN_HQCRMRS128_AVX2_hqc_pke_encrypt(uint64_t *u, uint64_t *v, uint8_t *m, unsigned char *theta, const unsigned char *pk) {
    ...
    // Compute u = r1 + r2.h
    PQCLEAN_HQCRMRS128_AVX2_vect_mul(u, r2, h);
    ...
    PQCLEAN_HQCRMRS128_AVX2_vect_mul(tmp2, r2, s);
    PQCLEAN_HQCRMRS128_AVX2_vect_add(tmp2, e, tmp2, VEC_N_256_SIZE_64);
    PQCLEAN_HQCRMRS128_AVX2_vect_add(tmp2, tmp1, tmp2, VEC_N_256_SIZE_64);
...
void PQCLEAN_HQCRMRS128_AVX2_hqc_pke_decrypt(uint8_t *m, const uint64_t *u, const uint64_t *v, const unsigned char *sk) {
    ...
    // Compute v - u.y
    PQCLEAN_HQCRMRS128_AVX2_vect_resize(tmp1, PARAM_N, v, PARAM_N1N2);
    PQCLEAN_HQCRMRS128_AVX2_vect_mul(tmp2, y, u);
    PQCLEAN_HQCRMRS128_AVX2_vect_add(tmp2, tmp1, tmp2, VEC_N_256_SIZE_64);
