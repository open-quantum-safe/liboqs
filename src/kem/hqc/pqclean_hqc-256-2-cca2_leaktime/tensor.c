...
void PQCLEAN_HQC2562CCA2_LEAKTIME_tensor_code_encode(uint8_t *em, const uint8_t *m) {
    ...
    PQCLEAN_HQC2562CCA2_LEAKTIME_bch_code_encode(tmp, m);
    PQCLEAN_HQC2562CCA2_LEAKTIME_repetition_code_encode(em, tmp);
}
...
void PQCLEAN_HQC2562CCA2_LEAKTIME_tensor_code_decode(uint8_t *m, const uint8_t *em) {
    ...
    PQCLEAN_HQC2562CCA2_LEAKTIME_repetition_code_decode(tmp, em);
    PQCLEAN_HQC2562CCA2_LEAKTIME_bch_code_decode(m, tmp);
}
