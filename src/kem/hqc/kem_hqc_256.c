...
extern int PQCLEAN_HQC256_CLEAN_crypto_kem_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *seed);
extern int PQCLEAN_HQC256_CLEAN_crypto_kem_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk);
extern int PQCLEAN_HQC256_CLEAN_crypto_kem_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *seed);
...
OQS_API OQS_STATUS OQS_KEM_hqc_256_keypair_derand(uint8_t *public_key, uint8_t *secret_key, const uint8_t *seed) {
	return (OQS_STATUS) PQCLEAN_HQC256_CLEAN_crypto_kem_keypair_derand(public_key, secret_key, seed);
}
...
OQS_API OQS_STATUS OQS_KEM_hqc_256_encaps_derand(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *seed) {
	return (OQS_STATUS) PQCLEAN_HQC256_CLEAN_crypto_kem_enc_derand(ciphertext, shared_secret, public_key, seed);
}
