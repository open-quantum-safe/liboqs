...
#if defined(OQS_ENABLE_KEM_hqc_rmrs_256)

OQS_KEM *OQS_KEM_hqc_rmrs_256_new() {

	OQS_KEM *kem = malloc(sizeof(OQS_KEM));
	if (kem == NULL) {
		return NULL;
	}
	kem->method_name = OQS_KEM_alg_hqc_rmrs_256;
	kem->alg_version = "2020-05-29";

	kem->claimed_nist_level = 5;
	kem->ind_cca = true;

	kem->length_public_key = OQS_KEM_hqc_rmrs_256_length_public_key;
	kem->length_secret_key = OQS_KEM_hqc_rmrs_256_length_secret_key;
	kem->length_ciphertext = OQS_KEM_hqc_rmrs_256_length_ciphertext;
	kem->length_shared_secret = OQS_KEM_hqc_rmrs_256_length_shared_secret;

	kem->keypair = OQS_KEM_hqc_rmrs_256_keypair;
	kem->encaps = OQS_KEM_hqc_rmrs_256_encaps;
	kem->decaps = OQS_KEM_hqc_rmrs_256_decaps;
...
#if defined(OQS_ENABLE_KEM_hqc_rmrs_256_avx2)
