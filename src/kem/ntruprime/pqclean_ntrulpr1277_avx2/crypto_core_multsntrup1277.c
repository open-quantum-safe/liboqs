...
#define h_10753 (aligned_h_10753.v)
    ...
    PQCLEAN_NTRULPR1277_AVX2_ntt512_7681(fgpad.v[0], 10);
    ...
    PQCLEAN_NTRULPR1277_AVX2_invntt512_7681(hpad[0], 5);
    ungood(h_7681, (const int16(*)[512])hpad);

    good(fpad, f);
    good(gpad, g);

    PQCLEAN_NTRULPR1277_AVX2_ntt512_10753(fgpad.v[0], 10);
    ...
    PQCLEAN_NTRULPR1277_AVX2_invntt512_10753(hpad[0], 5);
