...
int PQCLEAN_SNTRUP1277_AVX2_crypto_core_weightsntrup1277(unsigned char *outbytes, const unsigned char *inbytes) {
    ...
    PQCLEAN_SNTRUP1277_AVX2_crypto_encode_int16(outbytes, &weight);
    return 0;
}
