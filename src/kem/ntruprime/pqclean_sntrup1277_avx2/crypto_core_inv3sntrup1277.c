...
static inline void vec256_divx_5(vec256 *f) {
    ...
    unsigned long long low2 = (unsigned long long) _mm_cvtsi128_si64(_mm256_castsi256_si128(f2));
    unsigned long long low3 = (unsigned long long) _mm_cvtsi128_si64(_mm256_castsi256_si128(f3));
    unsigned long long low4 = (unsigned long long) _mm_cvtsi128_si64(_mm256_castsi256_si128(f4));
    ...
    f2 = _mm256_blend_epi32(f2, _mm256_set_epi64x(0, 0, 0, (long long) low2), 0x3);
    f3 = _mm256_blend_epi32(f3, _mm256_set_epi64x(0, 0, 0, (long long) low3), 0x3);
    f4 = _mm256_blend_epi32(f4, _mm256_set_epi64x(0, 0, 0, (long long) low4), 0x3);
...
int PQCLEAN_SNTRUP1277_AVX2_crypto_core_inv3sntrup1277(unsigned char *outbytes, const unsigned char *inbytes) {
    ...
    F0[4] = _mm256_set_epi32(0, 0, 0, 0, (int)2147483648, 0, (int)2147483648, 0);
    F1[0] = _mm256_set1_epi32(0);
    F1[1] = _mm256_set1_epi32(0);
    F1[2] = _mm256_set1_epi32(0);
    F1[3] = _mm256_set1_epi32(0);
    F1[4] = _mm256_set_epi32(0, 0, 0, 0, (int)2147483648, 0, (int)2147483648, 0);
