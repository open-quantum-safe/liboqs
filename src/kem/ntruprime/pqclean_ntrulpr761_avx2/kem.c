...
int PQCLEAN_NTRULPR761_AVX2_crypto_kem_keypair(uint8_t *pk, uint8_t *sk) {
    Fq aG[p];
    int i;
...
int PQCLEAN_NTRULPR761_AVX2_crypto_kem_enc(uint8_t *c, uint8_t *k, const uint8_t *pk) {
    int i;
...
int PQCLEAN_NTRULPR761_AVX2_crypto_kem_dec(uint8_t *k, const uint8_t *c, const uint8_t *sk) {
