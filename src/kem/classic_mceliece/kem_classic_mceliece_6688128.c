...
OQS_KEM *OQS_KEM_classic_mceliece_6688128_new(void) {
	...
	kem->length_keypair_coins = OQS_KEM_classic_mceliece_6688128_length_keypair_coins;
	kem->length_encaps_coins = OQS_KEM_classic_mceliece_6688128_length_encaps_coins;
