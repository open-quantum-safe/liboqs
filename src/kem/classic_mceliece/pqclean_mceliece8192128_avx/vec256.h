#ifndef PQCLEAN_MCELIECE8192128_AVX_VEC256_H
#define PQCLEAN_MCELIECE8192128_AVX_VEC256_H
/*
...
#define PQCLEAN_MCELIECE8192128_AVX_vec256_extract2x(a,i) ((vec128) _mm256_extractf128_si256((vec256) (a),(i)))
#define PQCLEAN_MCELIECE8192128_AVX_vec256_extract(a,i) ((uint64_t) _mm256_extract_epi64((vec256) (a),(i)))
...
extern void PQCLEAN_MCELIECE8192128_AVX_vec256_maa_asm(vec256 *, vec256 *, const vec256 *);
extern void PQCLEAN_MCELIECE8192128_AVX_vec256_ama_asm(vec256 *, vec256 *, const vec256 *);
