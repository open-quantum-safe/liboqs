...
extern int PQCLEAN_MCELIECE6960119F_AVX2_crypto_kem_keypair_derand(uint8_t *pk, uint8_t *sk);
extern int PQCLEAN_MCELIECE6960119F_AVX2_crypto_kem_keypair(uint8_t *pk, uint8_t *sk);
extern int PQCLEAN_MCELIECE6960119F_AVX2_crypto_kem_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
