...
extern gf PQCLEAN_MCELIECE8192128F_AVX_vec_reduce_asm(vec128 *);
extern void PQCLEAN_MCELIECE8192128F_AVX_update_asm(void *, gf, int);
...
void PQCLEAN_MCELIECE8192128F_AVX_bm(vec128 *out, vec256 *in) {
    ...
    for (N = 0; N < 256; N++) {
        ...
        t = PQCLEAN_MCELIECE8192128F_AVX_gf_mul2(c0, coefs[N], b);
        d ^= t & 0xFFFFFFFF;
