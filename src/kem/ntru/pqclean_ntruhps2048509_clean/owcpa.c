...
void PQCLEAN_NTRUHPS2048509_CLEAN_owcpa_samplemsg(unsigned char msg[NTRU_OWCPA_MSGBYTES],
    ...
    PQCLEAN_NTRUHPS2048509_CLEAN_sample_rm(&r, &m, seed);

    PQCLEAN_NTRUHPS2048509_CLEAN_poly_S3_tobytes(msg, &r);
    PQCLEAN_NTRUHPS2048509_CLEAN_poly_S3_tobytes(msg + NTRU_PACK_TRINARY_BYTES, &m);
}
...
void PQCLEAN_NTRUHPS2048509_CLEAN_owcpa_enc(unsigned char *c,
    ...
    PQCLEAN_NTRUHPS2048509_CLEAN_poly_S3_frombytes(r, rm);
