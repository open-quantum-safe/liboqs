...
static void fp2sqr751_c0_mont(const digit_t* a, digit_t* c);
void oqs_kem_sike_fp2sqr751_c0_asm(const digit_t* a, digit_t* c);
static void fp2sqr751_c1_mont(const digit_t* a, digit_t* c);
void oqs_kem_sike_fp2sqr751_c1_asm(const digit_t* a, digit_t* c);
...
static void fp2mul751_c0_mont(const digit_t* a, const digit_t* b, digit_t* c);
void oqs_kem_sike_fp2mul751_c0_asm(const digit_t* a, const digit_t* b, digit_t* c);
static void fp2mul751_c1_mont(const digit_t* a, const digit_t* b, digit_t* c);
void oqs_kem_sike_fp2mul751_c1_asm(const digit_t* a, const digit_t* b, digit_t* c);
