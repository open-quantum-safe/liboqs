...
void oqs_kem_sike_rdc610_asm(digit_t *ma, digit_t *mc);
...
static void fpmul610(const digit_t *a, const digit_t *b, digit_t *c);
void oqs_kem_sike_fpmul610_asm(const digit_t *a, const digit_t *b, digit_t *c);
...
static void fp2sqr610_c0_mont(const digit_t *a, digit_t *c);
void oqs_kem_sike_fp2sqr610_c0_asm(const digit_t *a, digit_t *c);
static void fp2sqr610_c1_mont(const digit_t *a, digit_t *c);
void oqs_kem_sike_fp2sqr610_c1_asm(const digit_t *a, digit_t *c);
...
static void fp2mul610_c0_mont(const digit_t *a, const digit_t *b, digit_t *c);
void oqs_kem_sike_fp2mul610_c0_asm(const digit_t *a, const digit_t *b, digit_t *c);
static void fp2mul610_c1_mont(const digit_t *a, const digit_t *b, digit_t *c);
void oqs_kem_sike_fp2mul610_c1_asm(const digit_t *a, const digit_t *b, digit_t *c);
