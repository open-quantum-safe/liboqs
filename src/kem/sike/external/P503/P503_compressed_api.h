...
int oqs_kem_sidh_p503_compressed_random_mod_order_A(unsigned char *random_digits);

// Generation of Bob's secret key
// Outputs random value in [0, 2^Floor(Log(2,3^159)) - 1] to be used as Bob's private key
int oqs_kem_sidh_p503_compressed_random_mod_order_B(unsigned char *random_digits);
