...
static void fpmul503(const digit_t* a, const digit_t* b, digit_t* c);
void oqs_kem_sike_fpmul503_asm(const digit_t* a, const digit_t* b, digit_t* c);
...
static void fp2sqr503_c0_mont(const digit_t* a, digit_t* c);
void oqs_kem_sike_fp2sqr503_c0_asm(const digit_t* a, digit_t* c);
static void fp2sqr503_c1_mont(const digit_t* a, digit_t* c);
void oqs_kem_sike_fp2sqr503_c1_asm(const digit_t* a, digit_t* c);
...
static void fp2mul503_c0_mont(const digit_t* a, const digit_t* b, digit_t* c);
void oqs_kem_sike_fp2mul503_c0_asm(const digit_t* a, const digit_t* b, digit_t* c);
static void fp2mul503_c1_mont(const digit_t* a, const digit_t* b, digit_t* c);
void oqs_kem_sike_fp2mul503_c1_asm(const digit_t* a, const digit_t* b, digit_t* c);
