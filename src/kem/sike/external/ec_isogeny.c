...
static void get_2_isog(const point_proj_t P, f2elm_t A24plus, f2elm_t C24)
...
static void CompleteMPoint(const f2elm_t A, const f2elm_t PX, const f2elm_t PZ, point_full_proj_t R)
