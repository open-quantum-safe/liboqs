...
#define OQS_KEM_sidh_keypair OQS_KEM_sidh_p503_keypair
#define OQS_KEM_sidh_encaps OQS_KEM_sidh_p503_encaps
#define OQS_KEM_sidh_decaps OQS_KEM_sidh_p503_decaps
