...
* Returns 0 (success)
**************************************************/
int PQCLEAN_KYBER76890S_AVX2_crypto_kem_keypair(unsigned char pk[KYBER_PUBLICKEYBYTES],
...
* Returns 0 (success)
**************************************************/
int PQCLEAN_KYBER76890S_AVX2_crypto_kem_enc(unsigned char ct[KYBER_CIPHERTEXTBYTES],
    ...
    PQCLEAN_KYBER76890S_AVX2_indcpa_enc(ct, buf, pk, kr + KYBER_SYMBYTES);
...
**************************************************/
int PQCLEAN_KYBER76890S_AVX2_crypto_kem_dec(unsigned char ss[KYBER_SSBYTES],
    ...
    /* coins are in kr+KYBER_SYMBYTES */
    PQCLEAN_KYBER76890S_AVX2_indcpa_enc(cmp.coeffs, buf, pk, kr + KYBER_SYMBYTES);

    fail = PQCLEAN_KYBER76890S_AVX2_verify(ct, cmp.coeffs, KYBER_CIPHERTEXTBYTES);

    /* overwrite coins in kr with H(c) */
    hash_h(kr + KYBER_SYMBYTES, ct, KYBER_CIPHERTEXTBYTES);

    /* Overwrite pre-k with z on re-encryption failure */
    PQCLEAN_KYBER76890S_AVX2_cmov(kr, sk + KYBER_SECRETKEYBYTES - KYBER_SYMBYTES, KYBER_SYMBYTES, fail);
