...
OQS_KEM *OQS_KEM_ledacrypt_kem_lt_52_new() {
	...
	kem->method_name = OQS_KEM_alg_ledacrypt_kem_lt_52;
	kem->alg_version = "2.?";

	kem->claimed_nist_level = 5;
	kem->ind_cca = true;

	kem->length_public_key = OQS_KEM_ledacrypt_kem_lt_52_length_public_key;
	kem->length_secret_key = OQS_KEM_ledacrypt_kem_lt_52_length_secret_key;
	kem->length_ciphertext = OQS_KEM_ledacrypt_kem_lt_52_length_ciphertext;
	kem->length_shared_secret = OQS_KEM_ledacrypt_kem_lt_52_length_shared_secret;

	kem->keypair = OQS_KEM_ledacrypt_kem_lt_52_keypair;
	kem->encaps = OQS_KEM_ledacrypt_kem_lt_52_encaps;
	kem->decaps = OQS_KEM_ledacrypt_kem_lt_52_decaps;
