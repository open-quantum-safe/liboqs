...
uint32_t PRIME8x[8]      = {OQS_RLWE_LATTICECRYPTO_PARAMETER_Q, OQS_RLWE_LATTICECRYPTO_PARAMETER_Q, OQS_RLWE_LATTICECRYPTO_PARAMETER_Q, OQS_RLWE_LATTICECRYPTO_PARAMETER_Q, OQS_RLWE_LATTICECRYPTO_PARAMETER_Q, OQS_RLWE_LATTICECRYPTO_PARAMETER_Q, OQS_RLWE_LATTICECRYPTO_PARAMETER_Q, OQS_RLWE_LATTICECRYPTO_PARAMETER_Q};
