...
#define OQS_RLWE_LATTICECRYPTO_PARAMETER_7Q4       21506 
#define OQS_RLWE_LATTICECRYPTO_PARAMETER_Q2        6145 
#define OQS_RLWE_LATTICECRYPTO_PARAMETER_3Q2       18434
    

// Macro definitions

#define OQS_RLWE_LATTICECRYPTO_NBITS_TO_NWORDS(nbits)      (((nbits)+(sizeof(digit_t)*8)-1)/(sizeof(digit_t)*8))    // Conversion macro from number of bits to number of computer words
#define OQS_RLWE_LATTICECRYPTO_NBYTES_TO_NWORDS(nbytes)    (((nbytes)+sizeof(digit_t)-1)/sizeof(digit_t))           // Conversion macro from number of bytes to number of computer words

// Macro to avoid compiler warnings when detecting unreferenced parameters
#define OQS_RLWE_LATTICECRYPTO_UNREFERENCED_PARAMETER(PAR) (PAR)
...
void oqs_rlwe_latticecrypto_NTT_CT_std2rev_12289_asm(int32_t* a, const int32_t* psi_rev, unsigned int N);
...
void oqs_rlwe_latticecrypto_INTT_GS_rev2std_12289_asm(int32_t* a, const int32_t* omegainv_rev, const int32_t omegainv1N_rev, const int32_t Ninv, unsigned int N);
...
void oqs_rlwe_latticecrypto_two_reduce12289_asm(int32_t* a, unsigned int N);
...
void oqs_rlwe_latticecrypto_pmul_asm(int32_t* a, int32_t* b, int32_t* c, unsigned int N);
...
void oqs_rlwe_latticecrypto_pmuladd_asm(int32_t* a, int32_t* b, int32_t* c, int32_t* d, unsigned int N);
...
void oqs_rlwe_latticecrypto_encode_asm(const uint32_t* pk, unsigned char* m);
