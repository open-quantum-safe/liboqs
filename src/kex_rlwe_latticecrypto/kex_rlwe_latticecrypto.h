/**
 * \file kex_rlwe_latticecrypto.h
 * \brief Header for ring-LWE key exchange protocol from the Microsoft LatticeCrypto library
 */

#ifndef __OQS_KEX_RLWE_LATTICECRYPTO_H
#define __OQS_KEX_RLWE_LATTICECRYPTO_H
...
void OQS_KEX_rlwe_latticecrypto_alice_priv_free(OQS_KEX *k, void *alice_priv);
