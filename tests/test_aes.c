...
static const uint8_t test_aes256ctr_iv[] = {0x00, 0x1C, 0xC5, 0xB7, 0x51, 0xA5, 0x1D, 0x70, 0xA1, 0xC1, 0x11, 0x48};
...
static int test_aes256ctr_correctness(void) {
	...
	OQS_AES256_CTR_sch(test_aes256ctr_iv, schedule, derived_ciphertext, sizeof(derived_ciphertext));
