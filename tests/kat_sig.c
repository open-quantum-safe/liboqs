...
OQS_STATUS combine_message_signature(uint8_t **signed_msg, size_t *signed_msg_len, const uint8_t *msg, size_t msg_len, const uint8_t *signature, size_t signature_len, const OQS_SIG *sig) {
	if (0) {
		...
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_I_K")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_I_K_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_I_B")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_I_B_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_I_S")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_I_S_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_III_K")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_III_K_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_III_B")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_III_B_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_III_S")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_III_S_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_V_K")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_V_K_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_V_B")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_V_B_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_V_S")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_V_S_AES")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-128F")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-EM-128S")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-EM-128F")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-192S")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-192F")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-EM-192S")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-EM-192F")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-256S")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-256F")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-EM-256S")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "FAEST-EM-256F")) {
		// signed_msg = msg || signature
		*signed_msg_len = msg_len + signature_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
