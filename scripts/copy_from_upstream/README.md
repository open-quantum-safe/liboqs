...
6. Run `python3 copy_from_upstream.py copy`, then `python3 copy_from_upstream.py verify`
7. Run `test_constant_time`; document any non-constant-time behaviour as described in [Constant-Time Testing](#constant-time-testing)
